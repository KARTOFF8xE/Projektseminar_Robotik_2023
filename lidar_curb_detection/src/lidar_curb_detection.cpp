...
lidar_curb_det::limit lidar_curb_det::curbstone_checker_absolut(std::vector<lidar_curb_det::lidar_measures> height_line, double height_diff, size_t max_check_length, double advanced_ray_check_thr, double wheel_inside, double wheel_width) {
    /**
...
lidar_curb_det::limit lidar_curb_det::curbstone_checker_vectors(std::vector<lidar_curb_det::lidar_measures> height_line, double height_diff, double angle_threshold, size_t max_check_length, double advanced_ray_check_thr, double wheel_inside) {    
...
lidar_curb_det::limit lidar_curb_det::filter_for_runaways(std::vector<lidar_curb_det::limit> limits_vec, double distance_thr, size_t quantity_check, size_t quantity_thr, size_t i) {
    /**
    ...
    */
    ...
    lidar_curb_det::limit limit_at_i = limits_vec[i];
...
lidar_curb_det::limit lidar_curb_det::get_avg_dist(std::vector<lidar_curb_det::limit> limits_vec, size_t quantity_check, size_t counter_thr, double avg_dist_thr, size_t i) {
    /**
    ...
    */
    ...
    /**
     * Returning an Object of lidar_curb_det::limit
    */
    return lidar_curb_det::limit{
        new_left,
        new_right,
...
lidar_curb_det::limit lidar_curb_det::check_for_valid_island(std::vector<lidar_curb_det::limit> limits_vec, size_t quantity_check, size_t counter_thr, size_t i) {
    /**
...
void lidar_curb_det::visualize_street_view(std::vector<lidar_curb_det::limit> limits_vec, double wheel_inside, double wheel_width) {
    /**
     * The left Limit of the Curbstone is drawn in green
     * The right Limit of the Curbstone is drawn in red
     * The Edges of the wheels are drawn in yellow

...
//filters::limit lidar_curb_det::filter_for_runaways(std::vector<filters::limit> limits_vec, double distance_thr, size_t quantity_check, size_t quantity_thr, size_t i) {
//    /**
...
// filters::limit lidar_curb_det::get_avg_dist(std::vector<filters::limit> limits_vec, size_t quantity_check, size_t counter_thr, double avg_dist_thr, size_t i) {
//     /**
...
// filters::limit lidar_curb_det::check_for_valid_island(std::vector<filters::limit> limits_vec, size_t quantity_check, size_t counter_thr, size_t i) {
//     /**
